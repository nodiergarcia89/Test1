...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[stgVentaArticulosClienteA] (
		...
		CONSTRAINT [PK_stgVentaArticulosClienteA]
		PRIMARY KEY
		CLUSTERED
...
GO
ALTER TABLE [dbo].[stgVentaArticulosClienteA]
	ADD
	CONSTRAINT [DF_stgVentaArticulosClienteA_ImportePLV]
	DEFAULT ((0)) FOR [ImportePLV]
GO
ALTER TABLE [dbo].[stgVentaArticulosClienteA] SET (LOCK_ESCALATION = TABLE)
GO
