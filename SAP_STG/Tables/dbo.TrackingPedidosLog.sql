...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[TrackingPedidosLog] (
		...
		CONSTRAINT [PK_TrackingPedidosLog]
		PRIMARY KEY
		CLUSTERED
		([codEmpresa], [nomIPad], [codPedido], [estadoTracking])
	ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY]
GO
ALTER TABLE [dbo].[TrackingPedidosLog] SET (LOCK_ESCALATION = TABLE)
GO
