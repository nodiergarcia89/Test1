...
-- Description:	Consumos Cliente Año
--				Mes actual año anterior
-- ========================================================
CREATE   view [dbo].[vstgF3ConsumosClienteMA] as
...
+ '<TR><TH><B>Producto</B></TH><TH><B>Cantidad</B></TH><TH><B>Importe</B></TH><TH><B>Precio</B></TH></TR>'
   + stuff( (
    ...
    FROM stgVentaArticulosClienteMA t2
...
FROM (
    ...
    FROM stgVentaArticulosClienteMA
) t
UNION ALL
-- Total cliente
