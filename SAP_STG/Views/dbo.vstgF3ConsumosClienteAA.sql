...
-- Description:	Consumos Cliente Año Anterior
-- ========================================================
CREATE view [dbo].[vstgF3ConsumosClienteAA] as
...
+ '<TR><TH><B>Producto</B></TH><TH><B>Cantidad</B></TH><TH><B>Importe</B></TH><TH><B>Precio</B></TH></TR>'
    ...
    FROM stgVentaArticulosClienteAA t2
...
FROM (
    ...
    FROM stgVentaArticulosClienteAA
) t
UNION ALL
-- Total cliente
