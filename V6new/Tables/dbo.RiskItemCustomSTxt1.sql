...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[RiskItemCustomSTxt1] (
		[RI_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__RiskItem__B80925FD17786E0C]
		PRIMARY KEY
		CLUSTERED
		([RI_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[RiskItemCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__RiskItemC__RI_Ke__3F7150CD]
	FOREIGN KEY ([RI_Key]) REFERENCES [dbo].[RiskItem] ([RI_Key])
ALTER TABLE [dbo].[RiskItemCustomSTxt1]
	CHECK CONSTRAINT [FK__RiskItemC__RI_Ke__3F7150CD]

GO
ALTER TABLE [dbo].[RiskItemCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
