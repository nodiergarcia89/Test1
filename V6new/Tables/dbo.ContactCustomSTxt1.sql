...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ContactCustomSTxt1] (
		[CN_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__ContactC__B138ECAC32767D0B]
		PRIMARY KEY
		CLUSTERED
		([CN_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ContactCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__ContactCu__CN_Ke__0E44098D]
	FOREIGN KEY ([CN_Key]) REFERENCES [dbo].[Contacts] ([CN_Key])
ALTER TABLE [dbo].[ContactCustomSTxt1]
	CHECK CONSTRAINT [FK__ContactCu__CN_Ke__0E44098D]

GO
ALTER TABLE [dbo].[ContactCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
