...
GO
CREATE TABLE [dbo].[PortfolioProfileCustomNum1] (
		[PSF_Key]        [int] NULL,
...
GO
ALTER TABLE [dbo].[PortfolioProfileCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [ProfileCustomNum1_fk]
	FOREIGN KEY ([PSF_Key]) REFERENCES [dbo].[PortfolioScenarioForecast] ([PSF_Key])
ALTER TABLE [dbo].[PortfolioProfileCustomNum1]
	CHECK CONSTRAINT [ProfileCustomNum1_fk]

GO
ALTER TABLE [dbo].[PortfolioProfileCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
