...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[AssignmentCustomSTxt1] (
		[AS_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__Assignme__3BC06B1201142BA1]
		PRIMARY KEY
		CLUSTERED
		([AS_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[AssignmentCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__Assignmen__AS_Ke__40106F4B]
	FOREIGN KEY ([AS_Key]) REFERENCES [dbo].[Assignment] ([AS_Key])
ALTER TABLE [dbo].[AssignmentCustomSTxt1]
	CHECK CONSTRAINT [FK__Assignmen__AS_Ke__40106F4B]

GO
ALTER TABLE [dbo].[AssignmentCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
