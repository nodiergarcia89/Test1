...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[TaskCustomSTxt1] (
		[TA_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__TaskCust__CBEBD6011466F737]
		PRIMARY KEY
		CLUSTERED
		([TA_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[TaskCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__TaskCusto__TA_Ke__69678A99]
	FOREIGN KEY ([TA_Key]) REFERENCES [dbo].[Task] ([TA_Key])
ALTER TABLE [dbo].[TaskCustomSTxt1]
	CHECK CONSTRAINT [FK__TaskCusto__TA_Ke__69678A99]

GO
ALTER TABLE [dbo].[TaskCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
