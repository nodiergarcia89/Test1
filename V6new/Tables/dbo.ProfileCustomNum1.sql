...
GO
CREATE TABLE [dbo].[ProfileCustomNum1] (
		...
		CONSTRAINT [PK__ProfileC__D56164A857FD0775]
		PRIMARY KEY
		CLUSTERED
		([PRF_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ProfileCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [FK__ProfileCu__PRF_K__26DAAD2D]
	FOREIGN KEY ([PRF_Key]) REFERENCES [dbo].[Profile] ([PRF_Key])
ALTER TABLE [dbo].[ProfileCustomNum1]
	CHECK CONSTRAINT [FK__ProfileCu__PRF_K__26DAAD2D]

GO
ALTER TABLE [dbo].[ProfileCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
