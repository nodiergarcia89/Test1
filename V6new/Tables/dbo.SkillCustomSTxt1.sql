...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[SkillCustomSTxt1] (
		...
		CONSTRAINT [PK__SkillCus__21013E1D77CAB889]
		PRIMARY KEY
		CLUSTERED
		([SK_Code])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[SkillCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__SkillCust__SK_Co__60D24498]
	FOREIGN KEY ([SK_Code]) REFERENCES [dbo].[Skill] ([SK_Code])
ALTER TABLE [dbo].[SkillCustomSTxt1]
	CHECK CONSTRAINT [FK__SkillCust__SK_Co__60D24498]

GO
ALTER TABLE [dbo].[SkillCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
