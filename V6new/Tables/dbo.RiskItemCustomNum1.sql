...
GO
CREATE TABLE [dbo].[RiskItemCustomNum1] (
		[RI_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__RiskItem__B80925FD13A7DD28]
		PRIMARY KEY
		CLUSTERED
		([RI_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[RiskItemCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [FK__RiskItemC__RI_Ke__3E7D2C94]
	FOREIGN KEY ([RI_Key]) REFERENCES [dbo].[RiskItem] ([RI_Key])
ALTER TABLE [dbo].[RiskItemCustomNum1]
	CHECK CONSTRAINT [FK__RiskItemC__RI_Ke__3E7D2C94]

GO
ALTER TABLE [dbo].[RiskItemCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
