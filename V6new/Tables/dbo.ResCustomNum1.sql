...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ResCustomNum1] (
		...
		CONSTRAINT [PK__ResCusto__096F08283A02903A]
		PRIMARY KEY
		CLUSTERED
		([RE_Code])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ResCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [FK__ResCustom__RE_Co__194BA7E5]
	FOREIGN KEY ([RE_Code]) REFERENCES [dbo].[Res] ([RE_Code])
ALTER TABLE [dbo].[ResCustomNum1]
	CHECK CONSTRAINT [FK__ResCustom__RE_Co__194BA7E5]

GO
ALTER TABLE [dbo].[ResCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
