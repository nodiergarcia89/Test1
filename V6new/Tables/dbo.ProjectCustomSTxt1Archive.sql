...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ProjectCustomSTxt1Archive] (
		...
		[PSS_Key]        [int] NULL,
		CONSTRAINT [PK__ProjectC__2B27E6301CA7377D]
		PRIMARY KEY
		CLUSTERED
		([PR_Code], [CU_Date])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ProjectCustomSTxt1Archive]
	WITH CHECK
	ADD CONSTRAINT [FK__ProjectCu__PR_Co__418EA369]
	FOREIGN KEY ([PR_Code]) REFERENCES [dbo].[Projects] ([PR_Code])
ALTER TABLE [dbo].[ProjectCustomSTxt1Archive]
	CHECK CONSTRAINT [FK__ProjectCu__PR_Co__418EA369]

GO
ALTER TABLE [dbo].[ProjectCustomSTxt1Archive]
	WITH CHECK
	ADD CONSTRAINT [FK__ProjectCu__PSS_K__6641052B]
	FOREIGN KEY ([PSS_Key]) REFERENCES [dbo].[ProjectSnapshots] ([PSS_Key])
ALTER TABLE [dbo].[ProjectCustomSTxt1Archive]
	CHECK CONSTRAINT [FK__ProjectCu__PSS_K__6641052B]

GO
ALTER TABLE [dbo].[ProjectCustomSTxt1Archive] SET (LOCK_ESCALATION = TABLE)
GO
