...
GO
CREATE TABLE [dbo].[AssignmentCustomNum1] (
		[AS_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__Assignme__3BC06B127D439ABD]
		PRIMARY KEY
		CLUSTERED
		([AS_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[AssignmentCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [FK__Assignmen__AS_Ke__3F1C4B12]
	FOREIGN KEY ([AS_Key]) REFERENCES [dbo].[Assignment] ([AS_Key])
ALTER TABLE [dbo].[AssignmentCustomNum1]
	CHECK CONSTRAINT [FK__Assignmen__AS_Ke__3F1C4B12]

GO
ALTER TABLE [dbo].[AssignmentCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
