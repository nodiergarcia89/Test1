...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ResCustomNum1Archive] (
		...
		CONSTRAINT [PK__ResCusto__A8BA8E673DD3211E]
		PRIMARY KEY
		CLUSTERED
		([RE_Code], [CU_Date])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ResCustomNum1Archive]
	WITH CHECK
	ADD CONSTRAINT [FK__ResCustom__RE_Co__1A3FCC1E]
	FOREIGN KEY ([RE_Code]) REFERENCES [dbo].[Res] ([RE_Code])
ALTER TABLE [dbo].[ResCustomNum1Archive]
	CHECK CONSTRAINT [FK__ResCustom__RE_Co__1A3FCC1E]

GO
ALTER TABLE [dbo].[ResCustomNum1Archive] SET (LOCK_ESCALATION = TABLE)
GO
