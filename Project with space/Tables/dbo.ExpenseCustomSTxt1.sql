...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ExpenseCustomSTxt1] (
		[EX_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__ExpenseC__905691221293BD5E]
		PRIMARY KEY
		CLUSTERED
		([EX_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ExpenseCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__ExpenseCu__EX_Ke__650CE9D0]
	FOREIGN KEY ([EX_Key]) REFERENCES [dbo].[Expense] ([EX_Key])
ALTER TABLE [dbo].[ExpenseCustomSTxt1]
	CHECK CONSTRAINT [FK__ExpenseCu__EX_Ke__650CE9D0]

GO
ALTER TABLE [dbo].[ExpenseCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
