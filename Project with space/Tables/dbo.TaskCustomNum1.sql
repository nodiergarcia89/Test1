...
GO
CREATE TABLE [dbo].[TaskCustomNum1] (
		[TA_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__TaskCust__CBEBD60110966653]
		PRIMARY KEY
		CLUSTERED
		([TA_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[TaskCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [FK__TaskCusto__TA_Ke__68736660]
	FOREIGN KEY ([TA_Key]) REFERENCES [dbo].[Task] ([TA_Key])
ALTER TABLE [dbo].[TaskCustomNum1]
	CHECK CONSTRAINT [FK__TaskCusto__TA_Ke__68736660]

GO
ALTER TABLE [dbo].[TaskCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
