...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ProjectCustomNum1Archive] (
		...
		[PSS_Key]        [int] NULL,
		CONSTRAINT [PK__ProjectC__2B27E630150615B5]
		PRIMARY KEY
		CLUSTERED
		([PR_Code], [CU_Date])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ProjectCustomNum1Archive]
	WITH CHECK
	ADD CONSTRAINT [FK__ProjectCu__PR_Co__3FA65AF7]
	FOREIGN KEY ([PR_Code]) REFERENCES [dbo].[Projects] ([PR_Code])
ALTER TABLE [dbo].[ProjectCustomNum1Archive]
	CHECK CONSTRAINT [FK__ProjectCu__PR_Co__3FA65AF7]

GO
ALTER TABLE [dbo].[ProjectCustomNum1Archive]
	WITH CHECK
	ADD CONSTRAINT [FK__ProjectCu__PSS_K__654CE0F2]
	FOREIGN KEY ([PSS_Key]) REFERENCES [dbo].[ProjectSnapshots] ([PSS_Key])
ALTER TABLE [dbo].[ProjectCustomNum1Archive]
	CHECK CONSTRAINT [FK__ProjectCu__PSS_K__654CE0F2]

GO
ALTER TABLE [dbo].[ProjectCustomNum1Archive] SET (LOCK_ESCALATION = TABLE)
GO
