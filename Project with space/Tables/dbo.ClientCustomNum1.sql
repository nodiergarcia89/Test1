...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ClientCustomNum1] (
		...
		CONSTRAINT [PK__ClientCu__B67F15557755B73D]
		PRIMARY KEY
		CLUSTERED
		([CL_Code])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ClientCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [FK__ClientCus__CL_Co__7854C86E]
	FOREIGN KEY ([CL_Code]) REFERENCES [dbo].[Clients] ([CL_Code])
ALTER TABLE [dbo].[ClientCustomNum1]
	CHECK CONSTRAINT [FK__ClientCus__CL_Co__7854C86E]

GO
ALTER TABLE [dbo].[ClientCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
