...
GO
CREATE TABLE [dbo].[PortfolioProjectCustomNum1] (
		[PSF_Key]        [int] NULL,
...
GO
ALTER TABLE [dbo].[PortfolioProjectCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [ProjectCustomNum1_fk]
	FOREIGN KEY ([PSF_Key]) REFERENCES [dbo].[PortfolioScenarioForecast] ([PSF_Key])
ALTER TABLE [dbo].[PortfolioProjectCustomNum1]
	CHECK CONSTRAINT [ProjectCustomNum1_fk]

GO
ALTER TABLE [dbo].[PortfolioProjectCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
