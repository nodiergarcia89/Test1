...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[DeliverableCustomSTxt1] (
		[DV_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__Delivera__F529BF2A3AD6B8E2]
		PRIMARY KEY
		CLUSTERED
		([DV_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[DeliverableCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__Deliverab__DV_Ke__3469B275]
	FOREIGN KEY ([DV_Key]) REFERENCES [dbo].[Deliverable] ([DV_Key])
ALTER TABLE [dbo].[DeliverableCustomSTxt1]
	CHECK CONSTRAINT [FK__Deliverab__DV_Ke__3469B275]

GO
ALTER TABLE [dbo].[DeliverableCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
