...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ContactCustomTxt1] (
		[CN_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__ContactC__B138ECAC36470DEF]
		PRIMARY KEY
		CLUSTERED
		([CN_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ContactCustomTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__ContactCu__CN_Ke__0F382DC6]
	FOREIGN KEY ([CN_Key]) REFERENCES [dbo].[Contacts] ([CN_Key])
ALTER TABLE [dbo].[ContactCustomTxt1]
	CHECK CONSTRAINT [FK__ContactCu__CN_Ke__0F382DC6]

GO
ALTER TABLE [dbo].[ContactCustomTxt1] SET (LOCK_ESCALATION = TABLE)
GO
