...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[PortfolioProfileCustomSTxt1] (
		[PSF_Key]        [int] NULL,
...
GO
ALTER TABLE [dbo].[PortfolioProfileCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [ProfileCustomSTxt1_fk]
	FOREIGN KEY ([PSF_Key]) REFERENCES [dbo].[PortfolioScenarioForecast] ([PSF_Key])
ALTER TABLE [dbo].[PortfolioProfileCustomSTxt1]
	CHECK CONSTRAINT [ProfileCustomSTxt1_fk]

GO
ALTER TABLE [dbo].[PortfolioProfileCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
