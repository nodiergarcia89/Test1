...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[RiskCustomSTxt1] (
		...
		CONSTRAINT [PK__RiskCust__419E2A3F0371755F]
		PRIMARY KEY
		CLUSTERED
		([RK_Code])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[RiskCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__RiskCusto__RK_Co__36DC0ACC]
	FOREIGN KEY ([RK_Code]) REFERENCES [dbo].[Risk] ([RK_Code])
ALTER TABLE [dbo].[RiskCustomSTxt1]
	CHECK CONSTRAINT [FK__RiskCusto__RK_Co__36DC0ACC]

GO
ALTER TABLE [dbo].[RiskCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
