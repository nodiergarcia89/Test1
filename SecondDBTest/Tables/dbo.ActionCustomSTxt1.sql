...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ActionCustomSTxt1] (
		[AN_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__ActionCu__FF73481A1BFD2C07]
		PRIMARY KEY
		CLUSTERED
		([AN_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ActionCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__ActionCus__AN_Ke__1DBB5747]
	FOREIGN KEY ([AN_Key]) REFERENCES [dbo].[Action] ([AN_Key])
ALTER TABLE [dbo].[ActionCustomSTxt1]
	CHECK CONSTRAINT [FK__ActionCus__AN_Ke__1DBB5747]

GO
ALTER TABLE [dbo].[ActionCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
