...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[PortfolioProjectCustomSTxt1] (
		[PSF_Key]        [int] NULL,
...
GO
ALTER TABLE [dbo].[PortfolioProjectCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [ProjectCustomSTxt1_fk]
	FOREIGN KEY ([PSF_Key]) REFERENCES [dbo].[PortfolioScenarioForecast] ([PSF_Key])
ALTER TABLE [dbo].[PortfolioProjectCustomSTxt1]
	CHECK CONSTRAINT [ProjectCustomSTxt1_fk]

GO
ALTER TABLE [dbo].[PortfolioProjectCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
