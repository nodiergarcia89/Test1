...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ContractCustomSTxt1] (
		...
		CONSTRAINT [PK__Contract__60B9BD8351EF2864]
		PRIMARY KEY
		CLUSTERED
		([CT_Number])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ContractCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__ContractC__CT_Nu__16D94F8E]
	FOREIGN KEY ([CT_Number]) REFERENCES [dbo].[Contract] ([CT_Number])
ALTER TABLE [dbo].[ContractCustomSTxt1]
	CHECK CONSTRAINT [FK__ContractC__CT_Nu__16D94F8E]

GO
ALTER TABLE [dbo].[ContractCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
