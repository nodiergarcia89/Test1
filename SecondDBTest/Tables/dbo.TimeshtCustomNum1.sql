...
GO
CREATE TABLE [dbo].[TimeshtCustomNum1] (
		[TS_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__TimeshtC__71342B243A8CA01F]
		PRIMARY KEY
		CLUSTERED
		([TS_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[TimeshtCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [FK__TimeshtCu__TS_Ke__050FA50E]
	FOREIGN KEY ([TS_Key]) REFERENCES [dbo].[Timesht] ([TS_Key])
ALTER TABLE [dbo].[TimeshtCustomNum1]
	CHECK CONSTRAINT [FK__TimeshtCu__TS_Ke__050FA50E]

GO
ALTER TABLE [dbo].[TimeshtCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
