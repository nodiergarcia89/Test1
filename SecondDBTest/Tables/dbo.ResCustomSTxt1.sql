...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[ResCustomSTxt1] (
		...
		CONSTRAINT [PK__ResCusto__096F082841A3B202]
		PRIMARY KEY
		CLUSTERED
		([RE_Code])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ResCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__ResCustom__RE_Co__1B33F057]
	FOREIGN KEY ([RE_Code]) REFERENCES [dbo].[Res] ([RE_Code])
ALTER TABLE [dbo].[ResCustomSTxt1]
	CHECK CONSTRAINT [FK__ResCustom__RE_Co__1B33F057]

GO
ALTER TABLE [dbo].[ResCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
