...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[TimeshtCustomSTxt1Audit] (
		...
		CONSTRAINT [PK__TimeshtC__6BA1B88145FE52CB]
		PRIMARY KEY
		CLUSTERED
		([TSS_Key], [TS_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[TimeshtCustomSTxt1Audit]
	WITH CHECK
	ADD CONSTRAINT [FK__TimeshtCustomSTx__07EC11B9]
	FOREIGN KEY ([TSS_Key], [TS_Key]) REFERENCES [dbo].[TimeshtAudit] ([TSS_Key], [TS_Key])
ALTER TABLE [dbo].[TimeshtCustomSTxt1Audit]
	CHECK CONSTRAINT [FK__TimeshtCustomSTx__07EC11B9]

GO
ALTER TABLE [dbo].[TimeshtCustomSTxt1Audit] SET (LOCK_ESCALATION = TABLE)
GO
