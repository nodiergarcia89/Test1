...
GO
CREATE TABLE [dbo].[ContactCustomNum1] (
		[CN_Key]         [int] NOT NULL,
		...
		CONSTRAINT [PK__ContactC__B138ECAC2EA5EC27]
		PRIMARY KEY
		CLUSTERED
		([CN_Key])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[ContactCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [FK__ContactCu__CN_Ke__0D4FE554]
	FOREIGN KEY ([CN_Key]) REFERENCES [dbo].[Contacts] ([CN_Key])
ALTER TABLE [dbo].[ContactCustomNum1]
	CHECK CONSTRAINT [FK__ContactCu__CN_Ke__0D4FE554]

GO
ALTER TABLE [dbo].[ContactCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
