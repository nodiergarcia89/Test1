...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[CostCentreCustomSTxt1] (
		...
		CONSTRAINT [PK__CostCent__D8CC4F1B6CA31EA0]
		PRIMARY KEY
		CLUSTERED
		([CC_Code])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[CostCentreCustomSTxt1]
	WITH CHECK
	ADD CONSTRAINT [FK__CostCentr__CC_Co__1F6E958F]
	FOREIGN KEY ([CC_Code]) REFERENCES [dbo].[CostCentre] ([CC_Code])
ALTER TABLE [dbo].[CostCentreCustomSTxt1]
	CHECK CONSTRAINT [FK__CostCentr__CC_Co__1F6E958F]

GO
ALTER TABLE [dbo].[CostCentreCustomSTxt1] SET (LOCK_ESCALATION = TABLE)
GO
