...
SET ANSI_PADDING ON
GO
CREATE TABLE [dbo].[RiskCustomNum1] (
		...
		CONSTRAINT [PK__RiskCust__419E2A3F7FA0E47B]
		PRIMARY KEY
		CLUSTERED
		([RK_Code])
	ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[RiskCustomNum1]
	WITH CHECK
	ADD CONSTRAINT [FK__RiskCusto__RK_Co__35E7E693]
	FOREIGN KEY ([RK_Code]) REFERENCES [dbo].[Risk] ([RK_Code])
ALTER TABLE [dbo].[RiskCustomNum1]
	CHECK CONSTRAINT [FK__RiskCusto__RK_Co__35E7E693]

GO
ALTER TABLE [dbo].[RiskCustomNum1] SET (LOCK_ESCALATION = TABLE)
GO
